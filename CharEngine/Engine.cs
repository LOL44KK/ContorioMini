// На будущее:
// - Добавить класс матрицы Pixel[,] (для начала придумать название, это самое сложное) 
// - Переработать TileMap
// 
// На далекое будущее:
// - Добавить в Pixel цвет фона
// - Добавить новый Renderer, который будет учитывать цвет фона
